...
<div class="admin">
  <div class="admin__inner">
    <div class="admin__weight">
        <p class="admin__goal-weight">目標体重</p>
        <p class="admin__weight">{{$weight_target->user->target_weight}}</p><span>kg</span>
    </div>
    <div class="admin__weight">
        <p class="admin__goal-weight">目標まで</p>
        <p class="admin__weight">{{$weight_target->user->target_weight}}</p><span>kg</span>
    </div>
    <div class="admin__weight">
        <p class="admin__new-weight">最新体重</p>
        <p class="admin__weight">{{$weight_logs->user->weight}}</p><span>kg</span>
    </div>
